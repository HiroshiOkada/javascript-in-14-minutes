...
function checkStep1(str) {
  if (str == 'Hello World!') {
    ...
    return console.log('JavaScript では 大文字と小文字を区別します。大文字と小文字を正しく入力して下さい。');
  }
...
function checkStep19(str) {
  ...
  console.log('"my_things" という配列を作成しインデックスが 1 である項目を選択してください。.');
}
...
function checkStep21(str) {
  ...
  console.log('"my_things" という名前の配列を作成し、"LOVE" という文字列を追加してください。');
}
...
function checkStep22(str) {
  ...
  console.log('"my_things" という名前の配列を作成し "The Button" という文字列を追加してください。');
}
...
function checkStep23(str) {
  ...
  console.log('"my_things" 名前の配列を作成し、"includes()" メソッドを呼び出して下さい。');
}
...
function checkArrayLoop(str, nextStep) {
  ...
  console.log('"my_things" という配列を作成し、それでループを回してください。');
}
...
function checkStep36(str) {
  ...
  console.log('"greet" という名前の関数を作成して、\'Alex\' というパラメータで呼び出して下さい。');
}
